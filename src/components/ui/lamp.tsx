  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        >
          <div className="absolute   h-[100%] right-0 bg-slate-950 w-full bottom-0 z-20 [mask-image:linear-gradient(to_left,white,transparent)]" />
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-36 w-full -translate-y-[6rem] rounded-full bg-slate-400 blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-[80rem] -translate-y-[7rem] bg-slate-400 "
        ></motion.div>
