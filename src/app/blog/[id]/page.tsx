        ...
        <Card className="bg-[#252525] border-[#333333] overflow-hidden">
          <CardHeader className="space-y-6 pb-8">
            <div className="space-y-4">
              <h1 className="text-4xl font-bold text-white bg-gradient-to-r from-[#f35900] to-[#ffb247] bg-clip-text text-transparent">
                {blogPost.title}
              </h1>

              <div className="flex items-center space-x-4">
                <div className="flex items-center space-x-3">
                  <Avatar className="w-12 h-12 border-2 border-[#f35900]/20">
                  ...
                  <div className="flex flex-col">
                    <div className="flex items-center text-sm text-gray-300">
                      <UserIcon className="w-4 h-4 mr-1 text-[#f35900]" />
              ...
              <div className="flex items-center space-x-6 text-sm text-gray-400">
                <div className="flex items-center">
                  <CalendarIcon className="w-4 h-4 mr-2 text-[#f35900]" />
                  <span>Published {blogPost.publishedDate}</span>
                </div>
                <div className="flex items-center">
                  <ClockIcon className="w-4 h-4 mr-2 text-[#f35900]" />
